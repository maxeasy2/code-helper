...
public class Constant {
	...
	public static final String[] GENERATE_TYPES = {"VO","milti-DTO","SQL-Insert","SQL-Update","SQL-Merge(Oracle)","jQuery-Ajax","JSP-EL-Tag"}; 
	...
	public static final int GENERATE_TYPES_SQL_MERGE = 4;
	public static final int GENERATE_TYPES_JQUERY_AJAX = 5;
	//public static final int GENERATE_TYPES_JSP_ELTAG = 6;
	...
	/**
	 * Generated  by Code-Helper
	 */
	public static final String GENERATE_COMMAND = "\t/**\n\t Generated by "+APPLICATION_NAME+"\n\t*/";
}